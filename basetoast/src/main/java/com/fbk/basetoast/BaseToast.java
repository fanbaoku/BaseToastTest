...
public class BaseToast extends Toast {
    ...
    private static void showToast(Context context, CharSequence text, int time, int imgType) {
        ...
        if (imgType == TYPE_HIDE) {
            ...
            if (imgType == TYPE_TRUE) {
                ...
                toast_img.setBackgroundResource(R.drawable.toast_x);
            }
     ...
     * @param imgType 图标状态
     */
    private static void showToast(Context context, int text, int time, int imgType) {
        // 初始化一个新的Toast对象
        initToast(context, text);
     ...
     * @param isSucceed 显示【对号图标】还是【叉号图标】
     */
    public static void showText(Context context, int text, boolean isSucceed) {
        showToast(context, text, Toast.LENGTH_SHORT, isSucceed ? TYPE_TRUE : TYPE_FALSE);
    }
     ...
     * @param time    持续的时间
     */
    public static void showText(Context context, int text, int time) {
        showToast(context, text, time, TYPE_HIDE);
    }
     ...
     * @param isSucceed 显示【对号图标】还是【叉号图标】
     */
    public static void showText(Context context, int text, int time, boolean isSucceed) {
        showToast(context, text, time, isSucceed ? TYPE_TRUE : TYPE_FALSE);
    }
}
